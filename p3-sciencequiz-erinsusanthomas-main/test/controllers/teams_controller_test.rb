...
class TeamsControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @team = FactoryBot.create(:team, organization: @organization)
  end
  ...
  test "should create team" do
    assert_difference('Team.count') do
      post teams_path, params: { team: { active: true, name: "Morewood 1", division: "junior", organization_id: @organization.id  } }
    end
  ...
  test "should update team" do
    patch team_path(@team), params: { team: { active: true, name: "Morewood 1", division: @team.division, organization_id: @team.organization.id  } }
    assert_redirected_to team_path(@team)
  end

  test "should not update an invalid team" do
    patch team_path(@team), params: { team: { active: true, name: nil, division: @team.division, organization_id: @team.organization.id  } }
